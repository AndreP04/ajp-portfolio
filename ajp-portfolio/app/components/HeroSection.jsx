      ...
      <div className="grid grid-cols-1 lg:grid-cols-12">
        ...
        >
          <h1 className="text-white mb-4 text-4xl sm:text-5xl lg:text-8xl lg:leading-normal font-extrabold">
            ...
            <br></br>
            <TypeAnimation
              sequence={["André", 1000, "A Full Stack Engineer", 2000, "A Problem Solver", 1000, "An Innovator", 1000]}
              wrapper="span"
              speed={50}
              repeat={Infinity}
            />
        ...
        >
          <div className="relative rounded-full bg-transparent w-[250px] h-[250px] lg:w-[400px] lg:h-[400px]">
            <Image
              src="/astronaut.png"
              alt="hero image"
              className="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 scale-80"
              width={300}
              height={300}
            />
          </div>
